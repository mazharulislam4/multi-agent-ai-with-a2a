...
async def main():
    ...
    logging.info("Starting Service Catalog Agent Server...")
    request_handler = DefaultRequestHandler(agent_executor=ServiceCatalogAgentExecutor(), task_store=InMemoryTaskStore()) # type: ignore
